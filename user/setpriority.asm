...
int main(int argc,char **argv)
{
  ...
  4c:	338080e7          	jalr	824(ra) # 380 <set_priority>
    exit(0);
  50:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d0:	45c50513          	addi	a0,a0,1116 # 828 <digits>
 3d4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49c:	390b8b93          	addi	s7,s7,912 # 828 <digits>
 ...
 5dc:	24890913          	addi	s2,s2,584 # 820 <malloc+0x102>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a4:	1a07b783          	ld	a5,416(a5) # 840 <freep>
 ...
 6d2:	00e6ea63          	bltu	a3,a4,6e6 <free+0x50>
{
 ...
 714:	12f73823          	sd	a5,304(a4) # 840 <freep>
}
 718:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 746:	0fe53503          	ld	a0,254(a0) # 840 <freep>
 ...
 76e:	0d690913          	addi	s2,s2,214 # 840 <freep>
  if(p == (char*)-1)
 772:	5afd                	li	s5,-1
 774:	a88d                	j	7e6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 776:	00000797          	auipc	a5,0x0
 77a:	0d278793          	addi	a5,a5,210 # 848 <base>
 77e:	00000717          	auipc	a4,0x0
 782:	0cf73123          	sd	a5,194(a4) # 840 <freep>
 786:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
