...
int main(int argc,char **argv)
{
  ...
  16:	1c4080e7          	jalr	452(ra) # 1d6 <atoi>
    trace(mask);
  1a:	1502                	slli	a0,a0,0x20
  1c:	9101                	srli	a0,a0,0x20
  1e:	00000097          	auipc	ra,0x0
  22:	358080e7          	jalr	856(ra) # 376 <trace>
    char **argv2 = argv;
    for(int i=2;i<=argc;i++)
  26:	4785                	li	a5,1
  28:	0297d063          	bge	a5,s1,48 <main+0x48>
  2c:	87ca                	mv	a5,s2
  2e:	ffe4871b          	addiw	a4,s1,-2
  32:	1702                	slli	a4,a4,0x20
  34:	9301                	srli	a4,a4,0x20
  36:	070e                	slli	a4,a4,0x3
  38:	00890693          	addi	a3,s2,8
  3c:	9736                	add	a4,a4,a3
    {
        argv2[i-2] = argv[i];
  3e:	6b94                	ld	a3,16(a5)
  40:	e394                	sd	a3,0(a5)
  ...
  44:	fee79de3          	bne	a5,a4,3e <main+0x3e>
    }
    exec(argv2[0],argv2);
  48:	85ca                	mv	a1,s2
  4a:	00093503          	ld	a0,0(s2)
  4e:	00000097          	auipc	ra,0x0
  52:	2c0080e7          	jalr	704(ra) # 30e <exec>
    exit(0);
  56:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	43e50513          	addi	a0,a0,1086 # 810 <digits>
 3da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	372b8b93          	addi	s7,s7,882 # 810 <digits>
 ...
 5e2:	22a90913          	addi	s2,s2,554 # 808 <malloc+0xe4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6aa:	1827b783          	ld	a5,386(a5) # 828 <freep>
 ...
 6d8:	00e6ea63          	bltu	a3,a4,6ec <free+0x50>
{
 ...
 71a:	10f73923          	sd	a5,274(a4) # 828 <freep>
}
 71e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 74c:	0e053503          	ld	a0,224(a0) # 828 <freep>
 ...
 774:	0b890913          	addi	s2,s2,184 # 828 <freep>
  if(p == (char*)-1)
 778:	5afd                	li	s5,-1
 77a:	a88d                	j	7ec <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 77c:	00000797          	auipc	a5,0x0
 780:	0b478793          	addi	a5,a5,180 # 830 <base>
 784:	00000717          	auipc	a4,0x0
 788:	0af73223          	sd	a5,164(a4) # 828 <freep>
 78c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ae:	06a73f23          	sd	a0,126(a4) # 828 <freep>
      return (void*)(p + 1);
